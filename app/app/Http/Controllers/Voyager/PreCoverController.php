...
class PreCoverController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $delete_Pre = PreCover::whereNull('shipment_src')->first();
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','src'));
    }
    ...
    public function store(Request $request)
    {
        ...
        (
            ...
            'shipment_src'=> $request->pre_cov
        );

        PreCover::create($Pre_Covv);
