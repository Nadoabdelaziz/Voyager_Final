...
class BarcodesController extends VoyagerBaseController
{
    ...
    {
        $brc=Barccode::whereNull('Barcode_id')->delete();
    ...
    public function store(Request $request)
    {
            ...
            for( $i=0 ; $i<$request->barcodes_no; $i++ , $barcode_id++){
