...
class SecondcoversController extends VoyagerBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $C_V=Coverrequest::where('id',$request->package_id)->first();


        Orderstatus::where('order_id',$C_V->order_id)->update([
        ...
        $O_status=Orderstatus::where('order_id',$C_V->order_id)->first();


                Packwindow::where('Arrival_ID',$C_V->order_id)->update([

                        'order_status'=>$O_status->Status,
                        'nd_shelf'=> $request->shelf,
                        'nd_row' => $request->row,
                        'nd_dimensions' => $request->package_dimensions,
                        'nd_weight' => $request->package_weight
